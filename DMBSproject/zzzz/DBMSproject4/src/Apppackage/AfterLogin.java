...
public class AfterLogin extends javax.swing.JFrame {
    ...
    private Statement st,st1,st2,st3,st4,st5,myst;
    private ResultSet rs,rs1,rs2,rs3,rs4,rs5,rs6,myrs;
    ...
    private void initComponents() {
        ...
        refund_field = new javax.swing.JTextField();
        ...
        jLabel21.setText("Eid(for staff members)");
                                ...
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                            ...
                                            .addGap(28, 28, 28)
                                            .addComponent(refund_field, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(refund_field, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel20))
                .addGap(64, 64, 64))
        );
  ...
  public String nextSessionId() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String eid=(String)jTextField8.getText();
        ...
        float ans=0;
        try{
            String myq ="select depart from govid where eno = \'" + eid + "\';";           
            myrs = myst.executeQuery(myq);            
            //myrs.beforeFirst();
            int f=0;
            while(myrs.next()){                
                depart = myrs.getString("depart");
                f=1;                
            }
            if(f==0)
                jTextField8.setText("Eid doesn't exists"); 
            
            if(depart.equals("safety"))
                concess*= 0.9;
            else if (depart.equals("personnel"))
                concess*=0.85;
            
       }
       catch(Exception ex){
           System.out.println("Error in concession"+ex);
       }
        try
        {
        ...
        if(rs.isBeforeFirst() && rs1.isBeforeFirst() && rs2.isBeforeFirst())
        {
         ...
         //  System.out.println(maxac1+maxac2+maxac3+maxsl1+maxsl2);
            ...
            if(rs.next())
            {
            int dis2=Integer.valueOf(rs.getString("dist"));
            ...
            if(rs3.isBeforeFirst())
                       ...
                       ans=ans*dis2;
                         ...
                         rs4=st4.executeQuery(q9);
                            ...
                            ans1 = String.valueOf(ans*concess);
                            int ansfare=(int)ans;
             ...
             anstime=rs4.getString("departuretime");
                             ...
                             {
                             int Ac11=Ac1;
                             q8="select sum(s.count) as my from seats_required as s,ticket as ti where ti.depart_date=\'"+ansdate+"\' and s.trainno=\'"+train+"\' and s.class='ac1seats' and ti.pnr=s.pnr;";
                            ...
                            else
                            {
                             ...
                             st1.executeUpdate(q8);
                                ...
                                {
                                 int ctr1;
                                q8="select max(waitno) as my from seats_waiting as s, ticket as ti where s.trainno=\'"+train+"\' and class=\'ac1seats\' and ti.pnr=s.pnr and ti.depart_date=\'"+ansdate+"\';";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr1=1;
                 ...
                 //               q8="insert into seats_waiting (class,pnr,trainno,waitno) values ( \'ac1seats\',\'"+pnrtrial+"\',\'"+train+"\',\'"+ctr1+"\' );";
                            ...
                            int Ac21=Ac2;
                             q8="select sum(s.count) as my from seats_required as s,ticket as ti where ti.depart_date=\'"+ansdate+"\' and s.trainno=\'"+train+"\' and s.class='ac2seats' and ti.pnr=s.pnr;";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr=0;
                            ...
                            else
                            {
                             ...
                             st1.executeUpdate(q8);
                                ...
                                {
                                 int ctr1;
                                 q8="select max(waitno) as my from seats_waiting as s, ticket as ti where s.trainno=\'"+train+"\' and class=\'ac2seats\' and ti.pnr=s.pnr and ti.depart_date=\'"+ansdate+"\';";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr1=1;
                 ...
                 //               q8="insert into seats_waiting (class,pnr,trainno,waitno) values ( \'ac1seats\',\'"+pnrtrial+"\',\'"+train+"\',\'"+ctr1+"\' );";
                             ...
                             int Ac31=Ac3;
                             q8="select sum(s.count) as my from seats_required as s,ticket as ti where ti.depart_date=\'"+ansdate+"\' and s.trainno=\'"+train+"\' and s.class='ac3seats' and ti.pnr=s.pnr;";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr=0;
                            ...
                            else
                            {
                             ...
                             st1.executeUpdate(q8);
                                ...
                                {
                                 int ctr1;
                                 q8="select max(waitno) as my from seats_waiting as s, ticket as ti where s.trainno=\'"+train+"\' and class=\'ac3seats\' and ti.pnr=s.pnr and ti.depart_date=\'"+ansdate+"\';";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr1=1;
                 ...
                 //               q8="insert into seats_waiting (class,pnr,trainno,waitno) values ( \'ac1seats\',\'"+pnrtrial+"\',\'"+train+"\',\'"+ctr1+"\' );";
                             ...
                             int Sl11=Sl1;
                             q8="select sum(s.count) as my from seats_required as s,ticket as ti where ti.depart_date=\'"+ansdate+"\' and s.trainno=\'"+train+"\' and s.class='sleeper1seats' and ti.pnr=s.pnr;";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr=0;
                            ...
                            else
                            {
                             ...
                             st1.executeUpdate(q8);
                                ...
                                {
                                 int ctr1;
                                 q8="select max(waitno) as my from seats_waiting as s, ticket as ti where s.trainno=\'"+train+"\' and class=\'sleeper1seats\' and ti.pnr=s.pnr and ti.depart_date=\'"+ansdate+"\';";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr1=1;
                 ...
                 //               q8="insert into seats_waiting (class,pnr,trainno,waitno) values ( \'ac1seats\',\'"+pnrtrial+"\',\'"+train+"\',\'"+ctr1+"\' );";
                             ...
                             int Sl21=Sl2;
                             q8="select sum(s.count) as my from seats_required as s,ticket as ti where ti.depart_date=\'"+ansdate+"\' and s.trainno=\'"+train+"\' and s.class='sleeper2seats' and ti.pnr=s.pnr;";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr=0;
                            ...
                            else
                            {
                                ...
                                {
                                 int ctr1;
                                 q8="select max(waitno) as my from seats_waiting as s, ticket as ti where s.trainno=\'"+train+"\' and class=\'sleeper2seats\' and ti.pnr=s.pnr and ti.depart_date=\'"+ansdate+"\';";
                             rs4=st4.executeQuery(q8);
                             rs4.next();
                             if((rs4.getString("my"))==null)
                                 ctr1=1;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       ...
       try
       {
          String q4="select * from fares where trainno=\'"+ train +"\' and class=\'ac1seats\';";
          rs= st.executeQuery(q4);
          rs.next();
           String fare_ac1=rs.getString("price");
           int fac1=Integer.valueOf(fare_ac1);
           
           q4="select * from fares where trainno=\'"+ train +"\' and class=\'ac2seats\';";
          rs= st.executeQuery(q4);
          rs.next();
           String fare_ac2=rs.getString("price");
           int fac2=Integer.valueOf(fare_ac2);
           
           q4="select * from fares where trainno=\'"+ train +"\' and class=\'ac3seats\';";
          rs= st.executeQuery(q4);
          rs.next();
           String fare_ac3=rs.getString("price");
           int fac3=Integer.valueOf(fare_ac3);
           
           q4="select * from fares where trainno=\'"+ train +"\' and class=\'sleeper1seats\';";
          rs= st.executeQuery(q4);
          rs.next();
           String fare_sl1=rs.getString("price");
           int fsl1=Integer.valueOf(fare_sl1);
           
           q4="select * from fares where trainno=\'"+ train +"\' and class=\'sleeper2seats\';";
          rs= st.executeQuery(q4);
          rs.next();
           String fare_sl2=rs.getString("price");
           int fsl2=Integer.valueOf(fare_sl2);
           //Ac1 Ac2 Ac3 S1 S2
           int tot=fac1*Ac1+fac2*Ac2+fac3*Ac3+fsl1*S1+fsl2*Ac2;
           q4="select * from ticket where pnr=\'"+ pnr +"\';";
           rs=st.executeQuery(q4);
           rs.next();
           String src=rs.getString("src_u");
           String des=rs.getString("des_u");
           
           String q3="select * from distance where stno1 =\'"+src+"\'and stno2=\'"+des+"\';";
            rs=st.executeQuery(q3);
            if(!rs.next())
            {
            q3="select * from distance where stno1 =\'"+des+"\'and stno2=\'"+src+"\';";
            rs=st.executeQuery(q3);
            }
            rs.beforeFirst();
            rs.next();
            String dis=rs.getString("dist");
            int dis1=Integer.valueOf(dis);
            tot=dis1*tot;
            String tot1=Integer.toString(tot);
            refund_field.setText(tot1);
            q4="select * from ticket where pnr=\'"+pnr+"\';";
            rs=st.executeQuery(q4);
            rs.next();
            String h=rs.getString("totalfare");
            int y=Integer.valueOf(h);
            y=y-tot;
            q4="update ticket set totalfare=\'"+y+"\' where pnr=\'"+pnr +"\';";
            st.executeUpdate(q4);
       }
       catch(Exception ex)
       {
    ...
    private javax.swing.JTextField refund_field;
