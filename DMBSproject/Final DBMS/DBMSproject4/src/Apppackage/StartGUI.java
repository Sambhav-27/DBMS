...
public class StartGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        train2 = new javax.swing.JTextField();
            ...
            .addGroup(FareLayout.createSequentialGroup()
                ...
                .addGroup(FareLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(FareLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(train2, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
                        .addComponent(from2))
        ...
        FareLayout.setVerticalGroup(
            ...
            .addGroup(FareLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(FareLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(train2, javax.swing.GroupLayout.PREFERRED_SIZE, 55, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(LoginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(LoginLayout.createSequentialGroup()
                        ...
                        .addGroup(LoginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(login_email1, javax.swing.GroupLayout.PREFERRED_SIZE, 536, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel32, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(LoginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(LoginLayout.createSequentialGroup()
                                    .addComponent(login_password, javax.swing.GroupLayout.PREFERRED_SIZE, 339, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jButton4, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, LoginLayout.createSequentialGroup()
                                    .addComponent(login_password1, javax.swing.GroupLayout.PREFERRED_SIZE, 345, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(107, 107, 107)
        ...
        LoginLayout.setVerticalGroup(
            ...
            .addGroup(LoginLayout.createSequentialGroup()
                ...
                .addGroup(LoginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(LoginLayout.createSequentialGroup()
                        .addGap(47, 47, 47)
                        .addComponent(login_res, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(LoginLayout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        ...
                        .addComponent(jLabel34)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(login_email1, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(23, 23, 23)
                .addGroup(LoginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jButton6, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(login_password1, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
 ...
 if(trainitr!=0){
       ...
       /////////////////////////////
        try{
            String q4 = "select trainno,departuretime from schedule where trainno in (select trainno from train where trainno in (select i.trainno from station s, intermediate_stations i where s.stname=\'" + src +"\' and s.stno=i.stno) and trainno in (select i.trainno from station s, intermediate_stations i where s.stname=\'" + des +"\' and s.stno=i.stno)) and stno=(select stno from station where stname=\'" + src+ "\');";
            String q5 = "select trainno,arrivaltime from schedule where trainno in (select trainno from train where trainno in (select i.trainno from station s, intermediate_stations i where s.stname=\'" + src +"\' and s.stno=i.stno) and trainno in (select i.trainno from station s, intermediate_stations i where s.stname=\'" + des +"\' and s.stno=i.stno)) and stno=(select stno from station where stname=\'" + des+ "\');";
            ...
            schedule.setText("No train exists between specified source and destination.");
        }
  ...
  //      if(seatitr!=0){
   ...
   //    seatitr+=1;
       ...
       try{
           String qz="select * from intermediate_stations s1,intermediate_stations s2 where s1.trainno=s2.trainno and s1.stno=\'"+ src1 +"\'and s2.stno=\'"+ dest1 +"\';";
           rs=st.executeQuery(qz);
           if(rs.isBeforeFirst())
           {
           while(rs.next())
           {
              System.out.println(rs.getString("trainno"));
             String q2 = "select * from train2 where trainno=\'"+rs.getString("trainno")+"\' and rdate=\'"+date+"\'";
             rs6=st2.executeQuery(q2);
             if(rs6.next())
             {
            String seats = rs6.getString(clas);
            String trainno = rs6.getString("trainno");
           ...
           if(f1==0)
           {
               answer.setText("No train on specified date Check other date");
           }
           }
           else
           {
               if(flag==0)
               answer.setText("No Direct Train exists!");
           }
       }
       catch(Exception ex){
           System.out.println(ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String q="";
       String classy=(String)classbox2.getSelectedItem();
       
       if(classy.equals("AC 1 tier"))
        classy="ac1seats";
        else if(classy.equals("AC 2 tier"))
        classy="ac2seats";
        else if(classy.equals("Ac 3 tier"))
        classy="ac3seats";
        else if(classy.equals("Sleeper 1 tier"))
        classy="sleeper1seats";
        else if(classy.equals("Sleeper 2 tier"))
        classy="sleeper2seats";
       
       String train=train2.getText();
       String from=from2.getText();
       String to=to2.getText();
       try
       {
           String q1="select * from station where stname=\'"+from+"\';";
           rs=st.executeQuery(q1);
           String q2="select * from station where stname=\'"+to+"\';";
           rs1=st1.executeQuery(q2);
           
           if(rs.next() && rs1.next())
           {
               String froms=rs.getString("stno");
               String tos=rs1.getString("stno");
              // System.out.println(froms+" "+tos);
               String q3="select * from distance where stno1 =\'"+froms+"\'and stno2=\'"+tos+"\';";
            rs=st.executeQuery(q3);
            if(!rs.next())
            {
            q3="select * from distance where stno1 =\'"+tos+"\'and stno2=\'"+froms+"\';";
            rs=st.executeQuery(q3);
            }
            rs.beforeFirst();
            if(rs.next())
            {
                int dis=Integer.valueOf(rs.getString("dist"));
                q="select * from train where trainno=\'"+train+"\';";
                q2="select * from intermediate_stations where stno=\'"+tos+"\' and trainno=\'"+train+"\';";
                q1="select * from intermediate_stations where stno=\'"+froms+"\' and trainno=\'"+train+"\' ;";
                rs1=st1.executeQuery(q1);
                rs2=st2.executeQuery(q2);
                rs=st.executeQuery(q);
                if(rs.next() && rs1.next() && rs2.next())
                {
                    q="select * from fares where trainno=\'"+ train+ "\'and class=\'"+ classy +"\' ;";
                    rs=st.executeQuery(q);
                    if(rs.next())
                    {
                    int val=Integer.valueOf(rs.getString("price"));
                    int ans1=dis*val;
                    String ans=Integer.toString(ans1);
                    answer2.setText("Cost of 1 seat "+ans);
                    }
                    else
                    {
                        answer2.setText("This tier Seat does not exist in this train!");
                    }
                }
                else
                {
                    answer2.setText("ERROR: No such train exists");
                }
            }
            else
            {
                answer2.setText("ERROR: Start and End points are same");
            }
           }
           else
           {
              answer2.setText("ERROR: Check Station Names");
           }
       }
       catch(Exception ex)
       {
       ...
       int fpswd=1;
        ...
        if(regitr!=0){
           ...
           Result.setText("You have been Registered. Stop Clicking again.");
            ...
            if(dob2.length()==8 && (dob2.charAt(4)=='0' || dob2.charAt(4)=='1')&& (dob2.charAt(6)=='0' || dob2.charAt(6)=='1'|| dob2.charAt(6)=='2' || dob2.charAt(6)=='3')){
                fdob=1;
            }
            else
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        String logemail=(String)login_email1.getText();
        String logpass=(String)login_password1.getText();
        
        try
        {

            if(logemail.equals("admin@rail.com") && logpass.equals("admin"))
            {
                login_res.setText("Login Successful");
                login_email1.setText("");
                login_password1.setText("");
                String args[]=new String[2];
                args[0]=logemail;
                AfterLoginAdmin.main(args);
                dispose();
            }
            else 
            {
    ...
    private javax.swing.JTextField train2;
